...
public interface IFieldDataService
{
    ...
    Task<IReadOnlyList<BuilderCompanyOption>> GetBuilderCompaniesAsync(CancellationToken cancellationToken = default);
    ...
    Task<Guid> QueueQuickClaimAsync(QuickClaimEntryDraft draft, CancellationToken cancellationToken = default);
    Task<Guid> QueueQuickServiceRequestAsync(QuickServiceRequestDraft draft, CancellationToken cancellationToken = default);
    ...
    Task UpdateWorkOrderRouteGroupAsync(Guid workOrderId, int? routeGroup, CancellationToken cancellationToken = default);
    Task ReorderScheduledWorkOrderAsync(Guid workOrderId, int direction, CancellationToken cancellationToken = default);
    Task ReorderRouteGroupAsync(Guid workOrderId, int direction, CancellationToken cancellationToken = default);
    Task TombstoneWorkOrderAsync(Guid workOrderId, CancellationToken cancellationToken = default);
